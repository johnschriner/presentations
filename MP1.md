...
<strong>3. UseBayes’ rule to rewrite the equation for ^T in terms of P(W | T) instead, and provide a prose explanation of each of the terms in the new equation.</strong><p>
...
The probability of sequence of words given the corresponding sequence of tags is directly proportional to the product of the probability of the word sequence and the probability of a tag given a particular word.
